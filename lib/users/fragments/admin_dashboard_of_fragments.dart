...
class AdminDashboardOfFragments extends StatelessWidget {
  ...
  late final List<Widget> _fragmentScreens;  // Declare the field

  AdminDashboardOfFragments(){
    _fragmentScreens = [
      AdminHomeFragmentScreen(),
      FavoritesFragmentScreen(userId: _rememberCurrentUser.user.user_id),
      OrderFragmentScreen(userId: _rememberCurrentUser.user.user_id),
